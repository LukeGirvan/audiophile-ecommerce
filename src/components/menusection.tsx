...
function MenuSection(){
    ...
    <div className="menu-section">
            ...
            <div className="menu-item">
                <img  alt="image of headphones" className="headphones" src={headPhoneImage}/>
                <h3>HEADPHONES</h3>
            ...
            <div className="menu-item">
                <img  alt="image of speakers" className="speakers" src={speakerImage} />
                <h3>SPEAKERS</h3>
                <div className="shop">SHOP <img 
                 alt="" className="right-arrow" src='assets/shared/desktop/icone-right-arrow.svg' /></div>
            </div>
            </Link>

            <Link to='/products/earphones' state={{from:location.pathname}} >
            <div className="menu-item">
                <img  alt="image of earphones" className="earphones" src={earphoneImage}/>
                <h3>EARPHONES</h3>
                <div className="shop">SHOP <img 
